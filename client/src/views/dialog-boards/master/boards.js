...
const DialogBoards = () => {
  ...
  const refresh = () => {
    dialogBoardService.getBoards().then((res) => {
              ...
              <CButton
                ...
                onClick={() => {
                  if (!searchKey.length) {
                    ...
                    setSearching(true)
                    dialogBoardService.getBoards({ title: searchKey }).then((res) => {
                      setSearching(false)
            ...
            {boards &&
              boards.map((item) => (
                <CCol
                  ...
                  onClick={() => {
                    setRedirect({ redirect: true, path: `/dialog-boards/getBoard/${item.id}` })
                  }}
                >
